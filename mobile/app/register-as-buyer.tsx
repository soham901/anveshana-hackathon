...
export default function RegisterFarmerPage() {
  const [formData, setFormData] = useState<FormData>({
    ...
    profile_pic: null,
    languages_spoken: "",
    preferred_quantity_unit: "kg",
    farm_size: "",
    farming_since: new Date(),
    preferred_selling_method: "",
  });
  ...
  const validateForm = () => {
    ...
    if (!formData.preferred_selling_method)
  ...
  return (
    <ScrollView>
      <ThemedView style={styles.container}>
        ...
        <Picker
          selectedValue={formData.preferred_quantity_unit}
          onValueChange={(value) =>
        ...
        >
          <ThemedText>{formData.farming_since.toDateString()}</ThemedText>
        </TouchableOpacity>
        {showDatePicker && (
          <DateTimePicker
